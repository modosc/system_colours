...
#define WRAPPED_VERSIONED_COLOR(name, version) juce::Colour StandardColours::name##Colour() {\
...
// WRAPPED_UNIMPLEMENTED_STANDARD_COLOR(systemBrown)


//iOS Colors

// An indigo color that automatically adapts to the current trait environment.
// WRAPPED_STANDARD_COLOR(systemIndigo)

// A teal color that automatically adapts to the current trait environment.
// WRAPPED_STANDARD_COLOR(systemTeal)

// Adaptable Gray Colors

// A second-level shade of grey.
// WRAPPED_STANDARD_COLOR(systemGray2)

// A third-level shade of grey.
// WRAPPED_STANDARD_COLOR(systemGray3)

// A fourth-level shade of grey.
// WRAPPED_STANDARD_COLOR(systemGray4)

// A fifth-level shade of grey.
// WRAPPED_STANDARD_COLOR(systemGray5)

// A sixth-level shade of grey.
// WRAPPED_STANDARD_COLOR(systemGray6)
